...
def main():
    ...
    log_dir = "./ppo_minigrid_figure_3a/"
    ...
    # if not os.path.exists('reward_model_data.pkl'):
    ...
    model.learn(12e4, callback=callback, progress_bar=True, tb_log_name="single_run", log_interval=None) # 2e5

    #     pickle.dump(reward_model.data, open('reward_model_data.pkl', 'wb'))
    # else:
    #     reward_model.data = pickle.load(open('reward_model_data.pkl', 'rb'))

    # reward_model.generate_test_set(SimpleEnv, log_dir)
    # reward_model.filter_train()

    # reward_model.learn() # //10)
    reward_model.learn(n_steps=4e4//40)# 1 5 40 80 160 320

    reward_model.eval_test()
