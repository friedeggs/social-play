...
def main():
    ...
    log_dir = f"./ppo_minigrid_figure_5-replicate-walls-handpicked-{args.mode}_env-1-{args.seed}/"
    save_path = os.path.join(log_dir, f"figure_5-replicate-walls-handpicked-{args.mode}_env-1-{args.seed}")
